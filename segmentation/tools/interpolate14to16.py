...
if __name__ == '__main__':
    ...
    parser.add_argument('--input', default='pretrained/eva_x_small_patch16_merged520k_mim.pt', type=str, metavar='PATH',
                        help='path to input EVA checkpoint with patch_embed kernel_size=14x14')
    parser.add_argument('--output', default='pretrained/eva_x_small_patch16_merged520k_mim.pt', type=str, metavar='PATH',
    ...
    if 'model' in checkpoint:
        checkpoint["module"] = checkpoint["model"]
    ...
    interpolate_pos_embed(checkpoint["module"], new_size=16)

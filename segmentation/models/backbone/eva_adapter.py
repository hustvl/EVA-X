...
from .eva_backbone import EvaTransformer
from .adapter_modules import SpatialPriorModule, InteractionBlockWithCls, deform_inputs

_logger = logging.getLogger(__name__)


@BACKBONES.register_module()
class EvaAdapter(EvaTransformer):

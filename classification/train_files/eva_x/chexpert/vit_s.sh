...
CKPT_DIR='output/chexpert/vit_s_eva_x_chexpert/checkpoint-best.pth'
# CKPT_DIR='pretrained/eva_x_small_patch16_merged520k_mim.pt'
SAVE_DIR='./output/chexpert/vit_s_eva_x_chexpert'
...
OMP_NUM_THREADS=1 python -m torch.distributed.launch \
    ...
    --warmup_epochs 0 \
    --drop_path 0.15 --mixup 0 --cutmix 0 --reprob 0 --vit_dropout_rate 0 \
